...
sets.Capacity = {back="Mecisto. Mantle",augments={'Cap. Point+46%','VIT+2','DEF+1'}}
...
gear.herculean_TA_head = { name="Herculean Helm", augments={'Attack+4','"Triple Atk."+3','Accuracy+12',}}
...
gear.Cichol_STRWS = { name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Damage taken-5%',}}
gear.Cichol_VITDEF = { name="Cichol's Mantle", augments={'VIT+20','Eva.+1 /Mag. Eva.+1','Evasion+1','"Fast Cast"+10','Phys. dmg. taken-2%',}}
gear.Cichol_DEXDA = { name="Cichol's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}}